...
# CONFIG
# -----------------------
BOT_TOKEN = os.getenv('BOT_TOKEN', '8403355550:AAFFrZYZoONoku5ocPE3LCMqxoJVeyEsM_k')
ADMIN_ID = int(os.getenv('ADMIN_ID', '8284391772'))
...
API_ID = int(os.getenv('API_ID', '37614317'))
API_HASH = os.getenv('API_HASH', '798f09283b984f396bb05328d49fc3e8')

# MUST JOIN CHANNEL
MUST_JOIN_CHANNEL = "@SpicyEryxDiary"

# Referral commission percentage
REFERRAL_COMMISSION = 1.5  # 1.5% per recharge

# Global API Credentials for Pyrogram Login
GLOBAL_API_ID = 37614317
GLOBAL_API_HASH = "798f09283b984f396bb05328d49fc3e8"
...
💰 Amount: {format_currency(amount)}/n/n
🌐 𝘾𝙡𝙞𝙘𝙠 𝙊𝙣 𝙏𝙝𝙚 𝙇𝙞𝙣𝙠 𝘼𝙣𝙙 𝙋𝙖𝙮 👇🏻/nhttps://razorpay.me/@nitinkumar3697
</blockquote>/n
...
3. Follow the steps to submit proof</blockquote>"""
        ...
        bot.send_photo(
            msg.chat.id,
            "https://files.catbox.moe/rswycj.jpg",
            caption=caption,
            parse_mode="HTML",
            reply_markup=markup
        )
